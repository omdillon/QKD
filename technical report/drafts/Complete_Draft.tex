...
The noise module supports six channel types: \texttt{none} (ideal channel), \texttt{depolarizing}, \texttt{bitflip}, \texttt{phaseflip}, \texttt{amplitude\_damping}, and \texttt{phase\_damping}. Of these, the depolarising, phase damping, and amplitude damping channels are the primary focus of the benchmarking analysis, as justified in the literature review. The bit-flip and phase-flip channels are included for completeness and validation purposes.
